...
"B32.бпел.нцп.лнл", "я   ", 	3,     30,     30, MT_DEC | M_PWP1 | M_NVM | M_RMAX(2) | M_PREC(1),	// {71, Regular,  }
...
"   G29.пегепб   ", "    ",		 0, 65535,		 0, MT_DEC | M_RONLY | M_RMAX(4), 		        // {258, Regular,  }
...
"ю27.йнмрп. ясллю", "    ", 	0,  65535,  	0, M_HSHOW|M_RMAX(3),			// {427, Regular,  }
