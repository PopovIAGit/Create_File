...
#define MB_SCALE			 (0.001 * 18000)	// Масштабировка для связи по протоколу ModBus
...
typedef struct _TMbParams {
	...
	Uns	 *pMbDiagEneble;		// Указатель на переменную разрешения диагностики Modbus
	Uns	 MpyTout;				// Множитель таймаутов
} TMbParams;
